...
import com.brettallen.bjswholesalescheduler.excel.ExcelFilenameFilter;
...
public class CsvConverter 
{
    ...
    //private static final int UNIX_STYLE_ESCAPING = 1;
                              ...
                              IllegalArgumentException, InvalidFormatException 
    {
        ...
        this.separator = CsvConverter.DEFAULT_SEPARATOR;
        this.formattingConvention = CsvConverter.EXCEL_STYLE_ESCAPING;
        ...
        for(File excelFile : filesList != null ? filesList : new File[0])
        {
            // Open the workbook
    ...
    private String escapeEmbeddedCharacters(String field) 
    {
        ...
        // convention....
        if(this.formattingConvention == CsvConverter.EXCEL_STYLE_ESCAPING) 
        {
